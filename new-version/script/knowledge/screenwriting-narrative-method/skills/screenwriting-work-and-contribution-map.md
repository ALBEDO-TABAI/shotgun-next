...
- 与其它模块的统一输入输出与状态含义见 [统一 skill 接口](/skills/unified-skill-interface.md)；按问题调用模块见 [按问题调用模块](/methods/call-modules-by-problem.md)。

# Citations
[1] [02 编剧工作与协作贡献建模 §九](../../../02_编剧工作与协作贡献建模.md)
