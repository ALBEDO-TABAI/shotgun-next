...
- 统一输入 / 输出与状态字段见 [统一 skill 接口](/skills/unified-skill-interface.md)；按问题调用模块见 [按问题调用模块](/methods/call-modules-by-problem.md)。
...
- 形式定位的前置模块：[叙事形式识别 skill](/skills/narrative-form-identification.md)。

# Citations
[1] [03 创作起点与具体问题建构 §十一](../../../03_创作起点与具体问题建构.md)
